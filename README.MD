...
- The active class [documentation](https://django-active-link.readthedocs.io/en/latest/) in Django helped us implement the Active light green to help users figure out where are on the site
